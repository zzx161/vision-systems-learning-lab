...
这课的目标不是做一个大项目，而是做一个能证明能力的闭环。
好的学习项目要让别人看见：你会定义问题、拆系统、实现、验证、解释结果。

建议按这条路线做：

1. 写项目 brief：目标、范围、输入、输出、约束。
2. 画系统图：模块、数据流、线程/进程、buffer 路径。
3. 做最小可运行版本：先跑通，再扩功能。
4. 加观测：耗时、资源、队列、错误统计。
5. 写结果页：展示现象、数据、结论、下一步。
